            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <div className="mt-4 pt-4 border-t">
                        <p className="text-sm text-muted-foreground mb-2">Indexar este video para que VIAD Bot pueda encontrarlo en el chat:</p>
                        <VectorizeButton type="video" itemId={id} />
                    </div>
                </CardContent>
            </Card>
        </div>
